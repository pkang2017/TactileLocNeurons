"""Datasets definitions for LOC-SNN.
...
class ViTacDataset(Dataset):
    def __init__(
        ...
        if mode == "vis" or mode == "mm":  # includes vision
            # print("Vision")
    ...
    def __getitem__(self, index):
        ...
        if self.mode == "tact" or self.mode == "location" or self.mode == "location_fuse" or self.mode == "only_location" or self.mode == "location_cat_whorl" or self.mode == "location_cat_arch" or self.mode == "location_cat_random":
            if self.rectangular:
                inputs = [
